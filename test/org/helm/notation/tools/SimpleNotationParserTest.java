...
public class SimpleNotationParserTest {
	...
	/*
	 * public String getInlineSmilesModP(){ return
	 * "[OP([*])([*])=O |$;;_R1;_R2;$|].R(A)[sP].RP.R(G)[OP([*])([*])=O |$;;_R1;_R2;$|].[LR]([5meC])"
	 * ; }
	 */
	...
	public String getRNANotationWithSalt() {
		return "P.R(A)[sP].R(A)[[Na+].[O-]P([*])([*])=O |$;;;_R1;_R2;$|].[LR]([5meC])";
	}

	public String getChemNotationWithSalt() {
		return "[Na+].[O-]C1C=CC(=O)N1CC1CCC(CC1)C([*])=O |$;;;;;;;;;;;;;;;;_R1;$,c:2|";
	}

	public String getPeptideNotationWithSalt() {
	...
	public void testMonomerCount() throws NotationException {
		...
		int count = SimpleNotationParser.getMonomerCount(
				getSimpleRNANotation(), Monomer.NUCLIEC_ACID_POLYMER_TYPE);
		assertEquals(11, count);

		count = SimpleNotationParser.getMonomerCount(
		...
		count = SimpleNotationParser.getMonomerCount(getSimpleChemNotation(),
				Monomer.CHEMICAL_POLYMER_TYPE);
		assertEquals(1, count);

		count = SimpleNotationParser.getMonomerCount(getSmilesNotation(),
				Monomer.CHEMICAL_POLYMER_TYPE);
		assertEquals(1, count);

		count = SimpleNotationParser.getMonomerCount(getRNANotationWithSalt(),
				Monomer.NUCLIEC_ACID_POLYMER_TYPE);
		assertEquals(9, count);

		count = SimpleNotationParser.getMonomerCount(getChemNotationWithSalt(),
				Monomer.CHEMICAL_POLYMER_TYPE);
		assertEquals(1, count);

		count = SimpleNotationParser.getMonomerCount(
				getPeptideNotationWithSalt(), Monomer.PEPTIDE_POLYMER_TYPE);
		assertEquals(6, count);

	}

	@Test
	public void testCanonicalNotation() throws NotationException,
			MonomerException, StructureException, JDOMException, IOException {

		String canonicalNotation = SimpleNotationParser
				.getSimpleCanonicalNotation(getSimpleRNANotation(),
						Monomer.NUCLIEC_ACID_POLYMER_TYPE);
		assertEquals("R(A)[sP].RP.R(G)P.[LR]([5meC])P", canonicalNotation);
		Map.Entry entry = SimpleNotationParser
				.getSimpleCanonicalNotationMapEntry(getSimpleRNANotation(),
						Monomer.NUCLIEC_ACID_POLYMER_TYPE);
		assertEquals("1", entry.getKey().toString());
		assertEquals("R(A)[sP].RP.R(G)P.[LR]([5meC])P", entry.getValue());

		canonicalNotation = SimpleNotationParser.getSimpleCanonicalNotation(
				getInlineSmilesModAdenine(), Monomer.NUCLIEC_ACID_POLYMER_TYPE);
		assertEquals(
				"R(C)P.R([C[N]1=CN=C(N)C2=C1N([*])C=N2 |$;;;;;;;;;_R1;;$,c:6,11,t:1,3|])[sP].RP.R(G)P.[LR]([5meC])P",
				canonicalNotation);

		canonicalNotation = SimpleNotationParser.getSimpleCanonicalNotation(
				getSimplePeptideNotation(), Monomer.PEPTIDE_POLYMER_TYPE);
		assertEquals("A.A.[seC].G.G.K", canonicalNotation);
		entry = SimpleNotationParser.getSimpleCanonicalNotationMapEntry(
				getSimplePeptideNotation(), Monomer.PEPTIDE_POLYMER_TYPE);
		...
		canonicalNotation = SimpleNotationParser.getSimpleCanonicalNotation(
				getInlineSmilesPeptideNotation(), Monomer.PEPTIDE_POLYMER_TYPE);
		assertEquals("A.[C[C@H](N[*])C([*])=O |$;;;_R1;;_R2;$|].[seC].G.G.K",
				canonicalNotation);

		canonicalNotation = SimpleNotationParser.getSimpleCanonicalNotation(
				getSimpleChemNotation(), Monomer.CHEMICAL_POLYMER_TYPE);
		...
		canonicalNotation = SimpleNotationParser.getSimpleCanonicalNotation(
				getSmilesNotation(), Monomer.CHEMICAL_POLYMER_TYPE);
		assertEquals("[*]OCCOCCOCCO[*] |$_R1;;;;;;;;;;;_R3$|",
				canonicalNotation);

		entry = SimpleNotationParser.getSimpleCanonicalNotationMapEntry(
				getSmilesNotation(), Monomer.CHEMICAL_POLYMER_TYPE);
		// assertEquals("0",entry.getKey().toString());
		// index depends on how often
		// SimpleNotationParser.generateNextChemMonomerID is called before.
		// assertEquals("CM#1",entry.getValue());

		canonicalNotation = SimpleNotationParser.getSimpleCanonicalNotation(
				getRNANotationWithSalt(), Monomer.NUCLIEC_ACID_POLYMER_TYPE);

		assertEquals(
				"R(A)[[Na+].[O-]P([*])([*])=O |$;;;_R1;_R2;$|].[LR]([5meC])P.R(A)[sP]",
				canonicalNotation);

		canonicalNotation = SimpleNotationParser.getSimpleCanonicalNotation(
				getChemNotationWithSalt(), Monomer.CHEMICAL_POLYMER_TYPE);
		assertEquals(getChemNotationWithSalt(), canonicalNotation);

		canonicalNotation = SimpleNotationParser.getSimpleCanonicalNotation(
				getPeptideNotationWithSalt(), Monomer.PEPTIDE_POLYMER_TYPE);
		assertEquals(
				"A.[seC].G.G.K.[[Na+].C[C@H](N[*])C([O-])[*] |$;;;;_R1;;;_R2$|]",
				canonicalNotation);

	}

	@Test
	public void testGetComplexNotation() throws NotationException,
			MonomerException, StructureException, JDOMException, IOException {

		String complexNotation = SimpleNotationParser.getComplexNotation(
				getSimpleRNANotation(), Monomer.NUCLIEC_ACID_POLYMER_TYPE);
		assertEquals("RNA1{P.R(A)[sP].RP.R(G)P.[LR]([5meC])}$$$$",
				complexNotation);

		complexNotation = SimpleNotationParser.getComplexNotation(
				getInlineSmilesModAdenine(), Monomer.NUCLIEC_ACID_POLYMER_TYPE);
		assertEquals(
				"RNA1{R(C)P.R([C[N]1=CN=C(N)C2=C1N([*])C=N2 |$;;;;;;;;;_R1;;$,c:6,11,t:1,3|])[sP].RP.R(G)P.[LR]([5meC])P}$$$$",
				complexNotation);
		...
		complexNotation = SimpleNotationParser.getComplexNotation(
				getSmilesNotation(), Monomer.CHEMICAL_POLYMER_TYPE);
		assertEquals("CHEM1{[*]OCCOCCOCCO[*] |$_R1;;;;;;;;;;;_R3$|}$$$$",
				complexNotation);
	...
	@Test
	public void testReplaceMonomer() throws MonomerException, IOException,
			JDOMException, NotationException {

		String result = SimpleNotationParser.replaceMonomer(
				getSimpleRNANotation(), Monomer.NUCLIEC_ACID_POLYMER_TYPE, "P",
				"sP");
		assertEquals("[sP].R(A)[sP].R[sP].R(G)[sP].[LR]([5meC])", result);

		result = SimpleNotationParser.replaceMonomer(
				getSimplePeptideNotation(), Monomer.PEPTIDE_POLYMER_TYPE, "A",
				"Q");
		assertEquals("G.G.K.Q.Q.[seC]", result);

		result = SimpleNotationParser.replaceMonomer(getSimpleChemNotation(),
				Monomer.CHEMICAL_POLYMER_TYPE, "PEG2", "SS3");
		assertEquals("SS3", result);

	}

	@Test
	public void testGetSmiles() throws IOException, NotationException,
		...
		result = SimpleNotationParser.getSimplePolymerSMILES(
				getRNANotationWithSalt(), Monomer.NUCLIEC_ACID_POLYMER_TYPE);
		String result1 = SimpleNotationParser.getSimplePolymerSMILES(
				"P.R(A)[sP].R(A)[naP].[LR]([5meC])",
				Monomer.NUCLIEC_ACID_POLYMER_TYPE);
	...
	@Test
	public void testValidation() throws IOException, NotationException,
			MonomerException, StructureException, JDOMException {

		assertTrue(SimpleNotationParser.validateSimpleNotation(
				getSimpleRNANotation(), Monomer.NUCLIEC_ACID_POLYMER_TYPE));
		...
		assertTrue(SimpleNotationParser.validateSimpleNotation(
				getRNANotationWithInline(), Monomer.NUCLIEC_ACID_POLYMER_TYPE));
	...
	@Test
	public void testGetMoleculeInfo() throws NotationException,
			MonomerException, IOException, JDOMException, PluginException,
			StructureException {

		MoleculeInfo mi = SimpleNotationParser.getMoleculeInfo(
				getSimpleRNANotation(), Monomer.NUCLIEC_ACID_POLYMER_TYPE);
		...
		mi = SimpleNotationParser.getMoleculeInfo(getInlineSmilesModAdenine(),
				Monomer.NUCLIEC_ACID_POLYMER_TYPE);
		...
		mi = SimpleNotationParser.getMoleculeInfo(getSimplePeptideNotation(),
		...
		mi = SimpleNotationParser.getMoleculeInfo(
				getInlineSmilesPeptideNotation(), Monomer.PEPTIDE_POLYMER_TYPE);
		assertEquals(552.48, mi.getMolecularWeight(), 1e-15);
		assertEquals("C19H35N7O7Se1", mi.getMolecularFormula());
		assertEquals(553.176318337, mi.getExactMass(), 1e-15);

		mi = SimpleNotationParser.getMoleculeInfo(getSimpleChemNotation(),
				Monomer.CHEMICAL_POLYMER_TYPE);
		...
		mi = SimpleNotationParser.getMoleculeInfo(getSmilesNotation(),
				Monomer.CHEMICAL_POLYMER_TYPE);
	...
	@Test
	public void testGetNucleotideList() throws NotationException,
		...
		System.out.println("getNucleotideList wo validation Start : "
				+ System.currentTimeMillis());
		nucleotideList = SimpleNotationParser
				.getNucleotideList(notation, false);
		...
		nucleotideList = SimpleNotationParser.getStrictNucleotideList(notation,
				false);
		...
		nucleotideList = SimpleNotationParser
				.getNucleotideList(getInlineSmilesModAdenine());
		assertEquals(5, nucleotideList.size());

		nucleotideList = SimpleNotationParser
				.getNucleotideList(getRNANotationWithSalt());
		assertEquals(4, nucleotideList.size());

		nucleotideList = SimpleNotationParser.getStrictNucleotideList(
				getRNANotationWithSalt(), true);
		assertEquals(4, nucleotideList.size());

	}

	@Test
	public void testGetNucleotideSequence() throws NotationException,
			MonomerException, IOException, JDOMException, StructureException {

		String notation = "R(C)P.R(G)P.R(A)P.R(U)P.R(A)P.R(U)P.R(G)P.R(G)P.R(G)P.R(C)P.R(U)P.R(G)P.R(A)P.R(A)P.R(U)P.R(A)P.R(C)P.R(A)P.R(A)P.[dR](U)P.[dR](U)";
		String nucleotideSeq = SimpleNotationParser
		...
		nucleotideSeq = SimpleNotationParser
				.getNucleotideSequence(getSimpleRNANotation());
		assertEquals("XAXGC", nucleotideSeq);

		nucleotideSeq = SimpleNotationParser
				.getNucleotideSequence(getInlineSmilesModAdenine());
		assertEquals("CXXGC", nucleotideSeq);

		nucleotideSeq = SimpleNotationParser
				.getNucleotideSequence(getRNANotationWithSalt());
		assertEquals("XAAC", nucleotideSeq);
	...
	public void testGetPeptideSequence() throws NotationException,
		...
		assertEquals("GGKAAC", SimpleNotationParser.getPeptideSequence(peptide));
		...
		assertEquals("GGKAXC", SimpleNotationParser.getPeptideSequence(peptide));
		...
		assertEquals("GGKXAC",
				SimpleNotationParser
						.getPeptideSequence(getPeptideNotationWithSalt()));

		assertEquals("G|G|K|PM#2|A|seC",
				SimpleNotationParser.getModifiedPeptideSequence(
						getPeptideNotationWithSalt(), "|"));

	}

	@Test
	public void testReplaceSmiles() throws NotationException, MonomerException,
			JDOMException, IOException {
		String notation = "[C[C@H](N[*])C(=O)C[*] |$;;;_R1;;;;_R2$|].G.G.G.C.C.K.K.K.K";
		String newNotation = SimpleNotationParser.getNotationByReplacingSmiles(
				notation, "PEPTIDE", MonomerFactory.getInstance()
						.getMonomerStore());
		assertEquals("[PM#1].G.G.G.C.C.K.K.K.K", newNotation);

		newNotation = SimpleNotationParser.getNotationByReplacingSmiles(
				getRNANotationWithSalt(), Monomer.NUCLIEC_ACID_POLYMER_TYPE,
				MonomerFactory.getInstance().getMonomerStore());

		assertEquals("P.R(A)[sP].R(A)[naP].[LR]([5meC])", newNotation);

		newNotation = SimpleNotationParser.getNotationByReplacingSmiles(
				getChemNotationWithSalt(), Monomer.CHEMICAL_POLYMER_TYPE,
				MonomerFactory.getInstance().getMonomerStore());

		assertEquals("CM#1", newNotation);

		newNotation = SimpleNotationParser.getNotationByReplacingSmiles(
				getPeptideNotationWithSalt(), Monomer.PEPTIDE_POLYMER_TYPE,
				MonomerFactory.getInstance().getMonomerStore());

		assertEquals("G.G.K.[PM#2].A.[seC]", newNotation);
	...
	public void testGetMonomerIDList() throws NotationException {
		...
		List<String> ids = SimpleNotationParser.getMonomerIDList(notation,
				"RNA");

		List<String> expectedIds = Arrays.asList("P", "R", "A", "sP", "R", "P",
				"R", "G", "P", "LR", "5meC");
		...
		expectedIds = Arrays.asList("NM#1", "A", "P", "R", "P", "NM#1", "T",
				"P", "R", "NM#2", "P", "R", "NM#3");
		assertEquals(expectedIds, ids);
		...
		ids = SimpleNotationParser.getMonomerIDList(getRNANotationWithSalt(),
				Monomer.NUCLIEC_ACID_POLYMER_TYPE);
		expectedIds = Arrays.asList("P", "R", "A", "sP", "R", "A", "naP", "LR",
				"5meC");
		assertEquals(expectedIds, ids);

		ids = SimpleNotationParser.getMonomerIDList(getChemNotationWithSalt(),
				Monomer.CHEMICAL_POLYMER_TYPE);
		expectedIds = Arrays.asList("CM#1");
		assertEquals(expectedIds, ids);

		ids = SimpleNotationParser.getMonomerIDList(
				getPeptideNotationWithSalt(), Monomer.PEPTIDE_POLYMER_TYPE);
		expectedIds = Arrays.asList("G", "G", "K", "PM#1", "A", "seC");
		assertEquals(expectedIds, ids);
